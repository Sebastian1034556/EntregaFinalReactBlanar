...
export function NavBar() {
    ...
    return (
        <nav className="fixed top-0 flex flex-wrap justify-between items-center p-8 text-white w-screen bg-custom-gradient z-50 md:flex-nowrap">
            <Link to="/">
            ...
            <ul className={`flex flex-row order-3 mx-auto md:mx-0 gap-6 mt-3 md:mt-0 md:gap-0  md:space-y-0 md:space-x-4 text-white :order-2  ${isOpen ? 'block' : 'hidden'} lg:block`}>
                ...
                <LinkComponent linkUrl="/category/Notebooks" linkText="Notebooks" />
                <LinkComponent linkUrl="/category/Accesorios" linkText="Accesorios" />
            </ul>
