    ...
    return (
        item ? (
            ...
            <div className="flex flex-col items-center max-w-lg mx-auto p-6 bg-white rounded-lg shadow-lg max-h-full">
                ...
                <h3 className="text-lg font-semibold mb-4 text-gray-600 text-center">{item.title}</h3>
            ...
            <button 
                className="text-2xl px-4 py-2 border border-transparent bg-black text-white rounded-lg shadow-md hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-300">
                Ir al checkout
            </button>
